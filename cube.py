...
def project(ax, cubes,color='b', camera_az=0.0, camera_elev=0.0, camera_ang=0.0):
    for cube in cubes:
        cube.project(ax, color=color, camera_az=camera_az, camera_elev=camera_elev, camera_ang=camera_ang)
...
s1 = render.Square3D(p1, p2, p3, p4)

p1 = render.Vector3D(-1, 1, 1)
p2 = render.Vector3D(-1, 1, -1)
p3 = render.Vector3D(-1, -1, -1)
p4 = render.Vector3D(-1, -1, 1)
s2 = render.Square3D(p1, p2, p3, p4)

p1 = render.Vector3D(1, -1, 1)
p2 = render.Vector3D(1, -1, -1)
p3 = render.Vector3D(-1, -1, -1)
p4 = render.Vector3D(-1, -1, 1)
s3 = render.Square3D(p1, p2, p3, p4)

p1 = render.Vector3D(1, 1, 1)
p2 = render.Vector3D(1, 1, -1)
p3 = render.Vector3D(1, -1, -1)
p4 = render.Vector3D(1, -1, 1)
s4 = render.Square3D(p1, p2, p3, p4)

p1 = render.Vector3D(1, 1, 1)
p2 = render.Vector3D(-1, 1, 1)
p3 = render.Vector3D(-1, -1, 1)
p4 = render.Vector3D(1, -1, 1)
s5 = render.Square3D(p1, p2, p3, p4)

p1 = render.Vector3D(1, 1, -1)
p2 = render.Vector3D(-1, 1, -1)
p3 = render.Vector3D(-1, -1, -1)
p4 = render.Vector3D(1, -1, -1)
s6 = render.Square3D(p1, p2, p3, p4)
...
def on_angle_changed(value):
    ...
    project(plt2, [s1, s2, s3, s4, s5, s6], color='k', camera_az=camera_az, camera_elev=camera_elev, camera_ang=camera_ang)
    canvas1.draw()
    c2.draw()
...
def on_azimuth_changed(value):
    ...
    plt2.plot([-2, 2, 2, -2, -2], [-2, -2, 2, 2, -2], color='r')
    project(plt2, [s1, s1, s3, s4, s5, s6], color='k', camera_az=camera_az, camera_elev=camera_elev, camera_ang=camera_ang)
    canvas1.draw()
    c2.draw()
